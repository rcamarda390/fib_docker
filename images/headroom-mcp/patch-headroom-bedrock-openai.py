#!/usr/bin/env python3
"""Apply fib_docker's Headroom 0.36.5 Bedrock/OpenAI compatibility patch.

This is intentionally a build-time source patch. It fails closed if the pinned
upstream source no longer matches the expected 0.36.5 call sites, forcing the
